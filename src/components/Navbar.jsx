...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0  w-full bg-opacity-70 backdrop-blur-md z-50'>
        <div className='w-full mx-auto sm:px-28 px-4 flex justify-between text-gray-200
        text-xl items-center h-20'>

            <a href="#">Shreyash Mangale</a>
            ...
            >
                <ul className='font-semibold text-2xl space-y-8 mt-24 text-center'>
                    <li><Link to="#" onClick={closeNav} smooth={true} offset={50} duration={500}>Home</Link></li>
